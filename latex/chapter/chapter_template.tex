...
% 			    need to span over multiple lines with a specific editorial criteria
...
% Please decide to spread out the title over 1, 2, 3 or 4 lines (at most) below
%\setNumberOfLinesForRunningTitle{2} 
\setTitleLineONE{Very Long Title of Your Very}   						% line ONE should be shorter than line TWO
\setTitleLineTWO{Long Contribution, Which Might Span Multiple Lines}		% line TWO should be shorter than line THREE     <-- this line will be ignored
\setTitleLineTHREE{}											% line THREE should be shorter than line FOUR
\setTitleLineFOUR{}
\newcommand{\headerTitleSplit}{\TitleLineONE 	 \\ \TitleLineTWO}
...
%\newcommand{\setNumberOfLinesForRunningTitle}[1]{
    \begin{switch}{3}
        \case{1}{
\newcommand{\headerTitleSplit}{\TitleLineONE}
        }
        \case{2}{
\newcommand{\headerTitleSplit}{\TitleLineONE 	 \\ \TitleLineTWO}
        }
        \case{3}{
\renewcommand{\headerTitleSplit}{\TitleLineONE 	 \\ \TitleLineTWO \\ 	\TitleLineTHREE}
       }
        \case{4}{
\newcommand{\headerTitleSplit}{\TitleLineONE 	 \\ \TitleLineTWO \\ 	\TitleLineTHREE \\ \TitleLineFOUR}
        }
    \end{switch}
%}
